...
<body>
	...
	<main>
		<div class="container py-5 text-center">
			...
			<form class="mb-2 d-flex flex-column" action="mangahq/validarlogin" method="post">
				...
				<div>
					<button type="submit" class="w-10 btn btn-primary px-4 mb-4">Entrar</button>
					<p class="mb-2">Ainda não tem uma conta?</p>
					<a href="mangahq/cadastrarusuario" class="w-10 btn btn-outline-secondary mt-1 px-4">Cadastre-se</a>
				</div>
			</form>
		</div>
	</main>
